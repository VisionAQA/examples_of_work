...
Привет, меня зовут Роман! В этом проекте вы сможете найти несколько примеров моего опыта работы с языками и почитать некоторую другую информацию обо мне. 

---

## Обо мне

60% времени ковыряю суровый бэк, API и хитрые интеграции (доводилось работать в диапазоне от консервативного страхового энтерпрайза до промышленных производственных линий). Основной домен - тестирование веб-приложений (front + back). Стараюсь смотреть на продукт глазами пользователя, а на требования - глазами аналитика. Люблю «раскопать» суть бага, найти цепочку, ведущую к его воспроизведению, и предложить решение, а не просто указать на дефект. Также, недавно начал проходить обучение автоматизации на Python.
...
— Высокая обучаемость, профессиональное любопытство, умение работать с большими объемами информации.  
— Умение грамотно оценивать трудозатраты и планировать рабочий процесс, декомпозиция сложных задач, высокий уровень self-менеджмента благодаря личному планированию в Trello.  
— Оттачиваю мастерство траблшутинга.  
...
<div id="badges">
  ...
  <a href="https://vk.com/rs_shmelkov" target="_blank">
    <img src="https://upload.wikimedia.org/wikipedia/commons/thumb/f/f3/VK_Compact_Logo_%282021-present%29.svg/500px-VK_Compact_Logo_%282021-present%29.svg.png.png" width="40" height="40" alt="vk" />
  </a>
</div>
