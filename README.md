...
Привет, меня зовут Роман! В этом проекте вы сможете найти несколько примеров моего опыта работы с языками и почитать другую информацию обо мне. 

---

## Обо мне

Я QA Engineer с 4+ годами практического опыта в ручном тестировании web, API и интеграционных решений. Основной домен — тестирование веб-приложений (front + back). Стараюсь смотреть на продукт глазами пользователя, а на требования — глазами аналитика. Люблю «раскопать» суть бага, найти цепочку, ведущую к его воспроизведению, и предложить решение, а не просто указать на дефект. Также, недавно начал проходить обучение автоматизации на Python.
